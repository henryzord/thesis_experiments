...
| Rule | Predicted class | Quality (precision * recall) |
|:----|----:|----:|
| Sex > -0.6995 and Age <= 2.076 | -1.0 | 0.621820 |
| Class <= -0.4508 | 1.0 | 0.647602 |
| Class <= 0.4932 | -1.0 | 0.201204 |
|  | 1.0 | 0.994429 |
...
rules | predicted class
---|---
Sex > -0.6995 AND Age <= 2.076|-1.0 (1284.0/260.0)
Class <= -0.4508|1.0 (201.0/9.0)
Class <= 0.4932|-1.0 (196.0/82.0)
|1.0 (17.0/2.0)
...
* Sex <= -1.92
	...
	* Class > -0.923
		* Class <= 0.0214
			* Age <= -0.228: -1.0 (97.0/48.0)
			* Age > -0.228: 1.0 (19.0/9.0)
		* Class > 0.0214: 1.0 (17.0/1.0)
* Sex > -1.92
	* Age <= -0.228: -1.0 (994.0/193.0)
	* Age > -0.228
		* Class <= -0.923: 1.0 (13.0)
		* Class > -0.923: -1.0 (31.0/9.0)
