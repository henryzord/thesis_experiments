...
|:----|----:|----:|
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix >= 11.5 and P_and >= 0.15 and P_and >= 0.523 | 1 | 0.889318 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix >= 11.5 and P_and >= 0.15 and P_and < 0.523 and Eccen >= 2.155 and Mean_tr < 5.2 and Blackand >= 56.5 | 1 | 0.225505 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen >= 7.5 and P_black >= 0.2405 and Mean_tr >= 4.09 and P_black >= 0.291 and Eccen >= 40.5 and Blackpix < 675.0 | 2 | 0.025084 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen >= 7.5 and P_black >= 0.2405 and Mean_tr >= 4.09 and P_black >= 0.291 and Eccen < 40.5 | 2 | 0.015629 |
| Height < 3.5 and Mean_tr < 1.355 and Blackpix < 44.5 | 1 | 0.084597 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix < 11.5 and P_black >= 0.241 and P_black < 0.6835 and Eccen < 1.225 and Eccen >= 0.3095 and Height < 7.5 and P_black >= 0.3635 | 1 | 0.053735 |
| Height >= 3.5 and Eccen >= 0.268 and Height >= 27.5 and P_black < 0.257 and Eccen < 3.345 | 5 | 0.007827 |
| Height > 3 and Eccen <= 0.25 and Eccen <= 0.091 | 4 | 0.007992 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen >= 7.5 and P_black >= 0.2405 and Mean_tr < 4.09 and Eccen >= 12.5 | 2 | 0.006629 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix < 11.5 and P_black >= 0.241 and P_black < 0.6835 and Eccen < 1.225 and Eccen >= 0.3095 and Height < 7.5 and P_black < 0.3635 | 1 | 0.040462 |
| Height >= 3.5 and Eccen >= 0.268 and Height >= 27.5 and P_black >= 0.257 and Eccen >= 1.2934999999999999 and Height < 82.5 and Lenght < 355.0 | 1 | 0.038698 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen < 7.5 and Eccen < 2.6665 | 1 | 0.036750 |
| Height >= 3.5 and Eccen < 0.268 and Eccen < 0.186 and Eccen >= 0.093 | 4 | 0.005139 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix >= 11.5 and P_and >= 0.15 and P_and < 0.523 and Eccen < 2.155 and P_black >= 0.1515 | 1 | 0.033380 |
| Height > 3 and Eccen > 0.25 and Height <= 27 and Blackpix > 11 and Mean_tr > 15.9 and Eccen > 17.556 | 2 | 0.003674 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr >= 30.134999999999998 and Eccen < 7.1535 | 1 | 0.023669 |
| Height > 3 and Eccen > 0.25 and Height <= 27 and Blackpix > 11 and Mean_tr <= 15.9 and P_and <= 0.523 and Wb_trans <= 34 and Height > 12 | 5 | 0.001756 |
| Height >= 3.5 and Eccen >= 0.268 and Height >= 27.5 and P_black >= 0.257 and Eccen < 1.2934999999999999 and Mean_tr >= 6.115 and Mean_tr >= 7.035 | 3 | 0.002852 |
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix < 11.5 and P_black < 0.241 and Blackand < 42.5 | 5 | 0.001935 |
| Height <= 3 and P_black > 0.228 and Lenght > 7 and Mean_tr <= 4.08 and Eccen <= 10.5 | 1 | 0.016469 |
| Height <= 3 and P_black > 0.228 and Lenght > 7 and Mean_tr <= 4.08 and Eccen > 10.5 and Mean_tr > 1.27 and Eccen <= 33 and P_black <= 0.592 and Mean_tr > 2.33 | 1 | 0.007200 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen >= 7.5 and P_black < 0.2405 and Eccen < 22.3335 | 1 | 0.011905 |
...
| Height >= 3.5 and Eccen >= 0.268 and Height < 27.5 and Mean_tr < 30.134999999999998 and Blackpix < 11.5 and P_black >= 0.241 and P_black < 0.6835 and Eccen < 1.225 and Eccen >= 0.3095 and Height >= 7.5 | 1 | 0.008964 |
| Height > 3 and Eccen > 0.25 and Height <= 27 and Blackpix <= 11 and Lenght > 2 and P_black > 0.241 and Eccen > 1.222 | 1 | 0.008891 |
| Height <= 2.5 and Eccen > 66.9375 and Wb_trans > 37.5 and Wb_trans <= 785 | 2 | 0.000864 |
| Height > 3 and Eccen > 0.25 and Height <= 27 and Blackpix > 11 and Mean_tr <= 15.9 and P_and <= 0.523 and Wb_trans > 34 | 1 | 0.200642 |
...
| Height >= 3.5 and Eccen >= 0.268 and Height >= 27.5 and P_black < 0.257 and Eccen >= 3.345 and Mean_tr < 3.36 | 1 | 0.007968 |
| Height < 3.5 and Mean_tr >= 1.355 and Eccen < 7.5 and Eccen >= 2.6665 and Mean_tr >= 3.835 and Blackpix >= 7.5 | 2 | 0.000900 |
| Height > 3 and Eccen > 0.25 and Height > 27 and P_black > 0.331 and Height > 91 | 3 | 0.002039 |
| Height > 26.5 and Eccen > 1.3605 and Eccen <= 6.9585 and Wb_trans > 785 | 5 | 0.000575 |
| Height <= 3 and P_black > 0.228 and Lenght <= 7 and Lenght > 5 | 1 | 0.007200 |
| Height >= 3.5 and Eccen >= 0.268 and Height >= 27.5 and P_black < 0.257 and Eccen >= 3.345 and Mean_tr >= 3.36 | 5 | 0.000741 |
...
| P_black > 0.373 and Eccen > 1.141 | 1 | 0.230463 |
...
(6.5-12.5]|(6.9585-34.9445]|(37.5-785]|1
...
(-inf-2.5]|(1.3605-6.9585]|(1.5-5.5]|1
