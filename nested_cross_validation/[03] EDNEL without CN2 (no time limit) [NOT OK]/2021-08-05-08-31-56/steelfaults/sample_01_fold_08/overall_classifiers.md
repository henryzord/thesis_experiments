...
|:----|----:|----:|
|  | 0 | 0.653295 |
| Length_of_Conveyer > 1353.5 and Length_of_Conveyer <= 1359 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.061728 |
...
| Length_of_Conveyer > 1375 and Length_of_Conveyer <= 1389.5 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.022298 |
| Length_of_Conveyer > 1649 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.155556 |
| Length_of_Conveyer > 1352.5 and Length_of_Conveyer <= 1353.5 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.050000 |
| Length_of_Conveyer > 1621 and Length_of_Conveyer <= 1649 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.015544 |
| Length_of_Conveyer > 1369 and Length_of_Conveyer <= 1375 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.037162 |
| Length_of_Conveyer > 1389.5 and Length_of_Conveyer <= 1397 and Pastry = 0 and Z_Scratch = 0 and K_Scatch = 0 and Stains = 0 and Dirtiness = 0 and Bumps = 0 | 1 | 0.012987 |
